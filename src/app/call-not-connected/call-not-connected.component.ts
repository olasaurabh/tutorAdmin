...
@Component({
  selector: 'app-call-not-connected',
  templateUrl: './call-not-connected.component.html',
  styleUrls: ['./call-not-connected.component.css']
})
export class CallNotConnectedComponent implements OnInit {
  ...
  ngOnInit() {
    this.tutorService.getCallNotConnectedTutors().subscribe(data => {
      console.log(data);
      this.tutors = data;
    })
  }
